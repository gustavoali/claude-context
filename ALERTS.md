...
|-------|------|---------|--------|
| 2026-03-28 | recordatorio | MCP Shared Gateway (`pj msg`): implementado. 6 servers via mcp-proxy, ahorro medido 1.6 GB (63%). Scripts Start/Stop/Status listos. Pendiente: activar en ~/.claude.json y validar E2E con sesion real | Activar: (1) `pwsh Start-Gateway.ps1`, (2) aplicar config HTTP (docs/claude-json-config.md), (3) reiniciar sesiones. Registrar en PA DB |
