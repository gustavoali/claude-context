...
| 2026-03-21 | recordatorio | Registrar project-management en Project Admin DB (slug: project-management, short: pm, context_path: C:/claude_context/capacitacion/project-management). PA DB estaba caida (WSL off) | Levantar WSL, ejecutar pa_create_project + pa_set_metadata |
