...
- [ARCHITECTURE_PR_ANALYZER.md](C:/claude_context/agentes/atlasOps/ARCHITECTURE_PR_ANALYZER.md) - Diseño técnico PR Analyzer
- [PRODUCT_BACKLOG_PR_ANALYZER.md](C:/claude_context/agentes/atlasOps/PRODUCT_BACKLOG_PR_ANALYZER.md) - User stories PR Analyzer
- [TASK_STATE.md](C:/claude_context/agentes/atlasOps/TASK_STATE.md) - Estado de tareas
