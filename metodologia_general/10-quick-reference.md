...
- `16-git-worktrees-parallel-agents.md` - Trabajo en paralelo con worktrees ⭐ NUEVO
- `17-memory-sync-pattern.md` - Sincronización de memoria CLAUDE.md ↔ claude_context ⭐ NUEVO
