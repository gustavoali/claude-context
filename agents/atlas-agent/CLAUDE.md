...
**Ubicacion:** C:/agents/atlas-agent
...
@C:/claude_context/agents/atlas-agent/PRODUCT_BACKLOG.md
@C:/claude_context/agents/atlas-agent/TASK_STATE.md
@C:/claude_context/agents/atlas-agent/ARCHITECTURE_ANALYSIS.md
